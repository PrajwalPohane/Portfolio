...
import { Github, Linkedin, Mail, ExternalLink, ChevronDown, Code2, Rocket, Brain, Terminal, Cpu, Wifi, Database, Cloud, Monitor, Heart, Coffee, Globe, Sparkles, Star, Zap, Award, Trophy, Target, User, MessageSquare, Phone, Code } from 'lucide-react';
...
function App() {
  ...
  const skills = [
    { name: "React", icon: Code2, color: "#00ffff", level: 60 },
    { name: "HTML", icon: Code, color: "#00ff00", level: 90 },
    { name: "CSS", icon: Code2, color: "#ff00ff", level: 90 },
    { name: "SQL", icon: Database, color: "#f0ff0f", level: 75 },
    { name: "FastAPI", icon: Cpu, color: "#ff0000", level: 75 },
    { name: "Python", icon: Code, color: "#00ff00", level: 85 },
    { name: "Flask", icon: Code2, color: "#ff0000", level: 70 },
  ];

  const achievements = [
    { icon: Trophy, text: "Best Developer Award 2023", color: "#00ffff" },
      ...
      <div className="relative z-10">
        ...
        <section className="min-h-screen flex flex-col items-center justify-center relative">
          ...
          >
            ...
            >
              <motion.a 
                href="https://github.com/PrajwalPohane?tab=repositories" 
          ...
          {[
            ...
            { Icon: Database, color: "#00ffff", position: "right-1/4 top-2/3", delay: 1.2 },
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              >
                <img 
                  ...
                  alt="Profile"
                  className="rounded-lg shadow-[0_0_30px_rgba(0,255,255,0.3)] transition-transform duration-500 group-hover:scale-105"
                />
        ...
        <footer className="py-8 relative">
          <div className="container mx-auto px-4 text-center">
            ...
            >
              ...
              <span>Made with love by Prajwal Pohane</span>
              <Heart className="text-[#ff00ff] w-4 h-4" />
            </motion.p>
          </div>
        </footer>
